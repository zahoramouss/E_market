    ...
    children: [
      ...
      Container(
        ...
        child: Text(
          ...
          style: TextStyle(
              fontWeight: FontWeight.w400, color: blue, fontFamily: stc_font),
        ),
      )
    ],
  );
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: (payed)
                              ? Image.asset(
                                  'assets/images/home-chariot-blue.png',
                                  scale: 6,
                                )
                              : Image.asset(
                                  'assets/images/home-chariot-blue-2.png',
                                  scale: 6),
                          onDoubleTap: () {
                            setState(() {
                              payed = !payed;
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: (payed)
                              ? Image.asset(
                                  'assets/images/big-chariot-orange-2.png',
                                  scale: 6)
                              : Image.asset(
                                  'assets/images/big-chariot-orange.png',
                                  scale: 6,
                                ),
                          onDoubleTap: () {
                            print(payed);
